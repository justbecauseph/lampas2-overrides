# Incendium 5.5.1 clock with Lampas2's mob-init scan throttled to every 5 ticks.
...
execute as @e[type=#incendium:mobs,scores={in.frozen=1..},predicate=incendium:random/10] run function incendium:entity/chilling
